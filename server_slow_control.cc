...
bool ServerControl::parse_command_config(std::string command_config_file)
{
...
void ServerControl::send_next_command()
{
...
void ServerControl::process_received_messages()
{
