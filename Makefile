...
slow_control_pi: protoc_middleman slow_control_pi.o sc_network.o picontrol.o runcontrol.o backplane_lowlevel.o
	$(CXX) $(CXXFLAGS) slow_control_pi.o sc_network.o picontrol.o runcontrol.o backplane_lowlevel.o sc_protobuf.pb.cc -o slow_control_pi $(LDFLAGS) -lbcm2835
