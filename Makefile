...
slow_control_pi: protoc_middleman slow_control_pi.o sc_network.o picontrol.o runcontrol.o sc_lowlevel.o
	$(CXX) $(CXXFLAGS) slow_control_pi.o sc_network.o picontrol.o runcontrol.o sc_lowlevel.o sc_protobuf.pb.cc -o slow_control_pi $(LDFLAGS) -lbcm2835
...
slow_control_server: protoc_middleman slow_control_server.cc sc_network.o servercontrol.o runcontrol.o
	$(CXX) $(CXXFLAGS) slow_control_server.cc sc_network.o servercontrol.o runcontrol.o sc_protobuf.pb.cc -o slow_control_server $(LDFLAGS) -lmysqlcppconn
...
clean:
	...
	rm -f sc_network.o sc_lowlevel.o
	rm -f runcontrol.o interfacecontrol.o servercontrol.o picontrol.o tmcontrol.o
