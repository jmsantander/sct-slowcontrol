...
slow_control_gui: protoc_middleman slow_control_gui.o sc_network.o
	$(CXX) $(CXXFLAGS) slow_control_gui.o sc_network.o sc_protobuf.pb.cc -o slow_control_gui $(LDFLAGS)
